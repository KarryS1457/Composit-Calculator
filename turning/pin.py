...
class pin(tk.Frame):
    def __init__(self, parent, presenter):
        ...
        self.ent_Dc = self.add_entry(left_frame, "Внешний диаметр 2 Dc (мм):")
    ...
    def run_calculation(self):
        try:
            payload = {
                ...
                "D2": 0,  # У штифта нет внутреннего отверстия
                "d": 0
            }
            self.controller.handle_lathe_calculation("pin", payload)
        except ValueError:
