...
class rotspher(tk.Frame):
    def __init__(self, parent, presenter):
        ...
        self.ent_as = self.add_entry(left_frame, "Глубина сферич. части as (мм):")
        ...
        self.set_image(resource_path("pics/rotarysphericalflange.jpg"))
    ...
    def run_calculation(self):
        try:
            payload = {
                ...
                "as": float(self.ent_as.get() or 0),
                "RS": float(self.ent_RS.get() or 0),
                "RA": float(self.ent_RA.get() or 0),
                "A1": float(self.ent_A1.get() or 0),
