...
class circle(tk.Frame):
    def __init__(self, parent, presenter):
        ...
        self.set_image(resource_path("pics/circle.jpg")) # Путь относительно корня проекта
    ...
    def run_calculation(self):
        try:
            payload = {
                ...
                "d": 0   # У круга нет внутреннего диаметра детали
            }
            # Отправляем в презентер с типом "circle"
            self.controller.handle_lathe_calculation("circle", payload)
        except ValueError:
