...
class weldflange(tk.Frame):
    def __init__(self, parent, presenter):
        ...
        self.ent_DM = self.add_entry(left_frame, "Диаметр проточки Dм (мм):")
        self.ent_a = self.add_entry(left_frame, "Глубина проточки a (мм):")
        self.ent_Dw = self.add_entry(left_frame, "Диаметр 2-й проточки Dw (мм):")
        ...
        self.set_image(resource_path("pics/weldingflange.jpg"))
    ...
    def run_calculation(self):
        try:
            ...
            self.controller.handle_lathe_calculation("welding_flange", payload)
        except ValueError:
