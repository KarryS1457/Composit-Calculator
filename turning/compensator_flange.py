...
class compensator(tk.Frame):
    def __init__(self, parent, presenter):
        ...
        self.ent_Dm1 = self.add_entry(left_frame, "Внешний диаметр канавки Dм1 (мм):")
        self.ent_dm2 = self.add_entry(left_frame, "Внутренний диаметр канавки dм2 (мм):")
        self.ent_K = self.add_entry(left_frame, "Глубина канавки K (мм):")
        self.ent_E = self.add_entry(left_frame, "Глубина упорного бурта E (мм):")
        ...
        self.set_image(resource_path("pics/compensatorflange.jpg"))
    ...
    def run_calculation(self):
        try:
            payload = {
                ...
                "K": float(self.ent_K.get() or 0),
                "E": float(self.ent_E.get() or 0),
            ...
            self.controller.handle_lathe_calculation("compensator", payload)
        except ValueError:
