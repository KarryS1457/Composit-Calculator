...
FEEDRATE_DATA = {
        '16K20':   [3, 0.15, 0.25],
        'Кнуб(1M63)':    [5, 0.19, 0.31],
        'Дип 500(1M65)':    [8, 0.3, 0.6],
        'VL-1600': [5, 0.5, 0.5],
        'CK5126':  [6, 0.5, 0.5]
    }
...
AWC_DATA = {
    ...
    300: [1.663, 1.590, 1.518, 1.445, 1.373, 1.300, 1.228, 1.155, 1.083],
    400: [1.617, 1.545, 1.472, 1.400, 1.327, 1.255, 1.182, 1.110, 1.037],
    500: [1.571, 1.499, 1.426, 1.354, 1.281, 1.209, 1.136, 1.064, 1.030],
    600: [1.526, 1.453, 1.381, 1.308, 1.236, 1.163, 1.091, 1.018, 1.020],
    700: [1.480, 1.408, 1.335, 1.263, 1.190, 1.118, 1.045, 1.030, 1.010],
